...
export const MCP_TOOLS: McpTool[] = [
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        query: { type: "string", description: "Company, product, or technology to analyze" },
      },
      required: ["query"],
    },
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        query: { type: "string", description: "Topic or product to build the marketing brief for" },
      },
      required: ["query"],
    },
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        query: { type: "string", description: "Technology or capability to analyze for existing plugins/APIs" },
      },
      required: ["query"],
    },
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        query: { type: "string", description: "Research topic or question to search academic databases" },
      },
      required: ["query"],
    },
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        query: { type: "string", description: "Topic to get a news briefing for" },
      },
      required: ["query"],
    },
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        query: { type: "string", description: "Market, industry, or financial topic to scan" },
        currency: { type: "string", description: "Base currency for exchange rate context (default: USD)" },
      },
      required: ["query"],
    },
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        query: { type: "string", description: "Location to research (city, region, country, or address)" },
      },
      required: ["query"],
    },
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        query: { type: "string", description: "Health topic, condition, treatment, or medical question to research" },
      },
      required: ["query"],
    },
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        query: { type: "string", description: "Technology, framework, or tool to evaluate" },
      },
      required: ["query"],
    },
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        query: { type: "string", description: "Claim or statement to fact-check" },
      },
      required: ["query"],
    },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        format: { type: "string", description: "Content format: 'blog post', 'article', 'newsletter', etc. (default: blog post)" },
      },
      required: ["query"],
    },
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        attendee_name: { type: "string", description: "Full name of the meeting attendee" },
        attendee_company: { type: "string", description: "Company of the meeting attendee" },
        meeting_title: { type: "string", description: "Title or subject of the meeting" },
        meeting_time: { type: "string", description: "Date and time of the meeting" },
        meeting_duration_minutes: { type: "number", description: "Duration of the meeting in minutes" },
        meeting_location: { type: "string", description: "Location or video link for the meeting" },
      },
